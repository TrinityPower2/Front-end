                            ...
                            <div class="loginForm">
                                ...
                                <div class="created-tasks-container">
                                    <div class="created-tasks-new-container">
                                        ...
                                        </div><font-awesome-icon icon="fa-solid fa-plus" size="sm" class="new-task-remove"
                                            style="transform:rotate(45deg); margin-left: 13px;" />
                                    </div>
                                    <div class="created-tasks-new-container">
            ...
            <div id="myModaladdNewCalendar" class="modal">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-center">
                        <p style="margin-top: 50px;">Would you like to create a new calendar or add it to an existing one ?
                        </p>
                        <div class="delete-list-button">
                            <div class="AddTaskInputBox no">
                                <input class="close" type="submit" value="Add to Calendar" name="submit"
                                    id="add-to-pop-up" />
                            </div>
                            <div class="AddTaskInputBox no">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-center2">
                        <div class="New-list-element">
                            ...
                            <div id="drop_zone1" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);"
                                class="help-input">
                                <p style="color: rgba(27, 27, 27, 0.473);">Drag a file here...</p>
                            </div><br>
                        </div>
                        <div class="New-list-element">
                            <div class="new-list-desc">
