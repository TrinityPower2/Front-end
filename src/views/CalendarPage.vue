    ...
    <body>
        ...
        <div class="Calendar-page-container">
            <div class="calendar-sidebar-container">
                <button :class='"Your-calendar-button-" + cal.calendar_color' v-for = "(cal, index) in Calendar" :key = "index" @click = "DisplayCalendar(cal.id_calendar)">
            ...
            <div class="calendar-display-container">
                <div class="calendar-top-buttons">
                    <div class="choose-week">
                        <div>
                            <input ref="weekInput" type="week" class="Create-planning-Btn" v-model="selectedWeek" @change="handleWeekChange">
                        </div>
                        <font-awesome-icon icon="fa-solid fa-angle-left" class="arrow-left-calendar" @click = "ChangeWeek(-1)"/>
                        <font-awesome-icon icon="fa-solid fa-angle-right" class="arrow-left-calendar" @click = "ChangeWeek(+1)" />
                    </div>
                    <button class="Create-planning-Btn" id="addCalendar" @click = "OpenNewCalendar">
                        Add Event
                    </button>
                    <button class="Create-planning-Btn" id="addCalendar" @click = "Reload">
                        Reload
                    </button>
                </div>
                        ...
                        <div class="days">
                            <div v-for="(cal, index) in EventByWeek" :key="index" >
                                <div :class='"day " + cal.day'>
                                    ...
                                    <div class="events" >
                                        <div class = "events"  v-for="(event, Evindex) in cal.events" :key="Evindex" :id="`calendar-${index}`" v-show="shouldDisplayCalendar(cal.id_cal)">
                                            <div :id = 'cal.id_cal + "-" + event.event.id_event' :class='"event start-"+ event.event.f_start_date + " end-" + event.event.f_end_date + " "+ event.event.color + " calendar-" + cal.calendar_color'  @click="OpenLoadCalendarModal(event.event.id_event, cal.id_cal)">
                                            <p class="calendar-title" >{{event.event.name_event}}</p>
                                            <p class="calendar-time">{{event.event.start_date.slice(-8).replace(/(\d+)-(\d+)/, "$1H$2")}} - {{event.event.end_date.slice(-8).replace(/(\d+)-(\d+)/, "$1H$2")}}</p>
                                            </div>
                                            </div>   
                                            </div>
                                        </div>
                            ...
                            <div class="modal-center1">
                                ...
                                <div class="Timeslots-choice">
                                    <div class="custom-select" id="Time-Task" >
                                        <input class="select-items" type="date" id="day" 
                                    name="day-task" v-model = "SelectedDate" min="2023-04-01" max="2028-12-31">
                                </div>
                            </div>
                        </div>
                        <div class="New-list-element1">
                            ...
                            <font-awesome-icon icon="fa-regular fa-hourglass-half" size="xl"
                                ...
                                <div class="Timeslots-choice">
                                <div class="custom-select" id="Time-Task" >
                                    <input class="select-items" type="time" id="day" 
                                name="day-task" v-model = "StartTime" min="6:00" max="23:00">
                                </div>
                                <div class="custom-select" id="Time-Task" >
                                    <input  class="select-items" type="time" id="day" 
                                name="day-task" v-model = "EndTime" min="6:00" max="23:00">
                                </div>  
                            </div>
                        </div>
            ...
            <div id="LoadCalendarModal" class="modal1">
                    ...
                    <div class="modal-center1">
                        ...
                        <!--<div class="New-list-element1" style="margin-top: 40px">
                            ...
                            <font-awesome-icon icon="fa-regular fa-clock" size="xl"
                                style="color: rgba(85, 84, 85, 0.986)" />
                            <div class="custom-select">
                                <select class="select-items"  v-model = "SelectedLength">
              ...
              margin-top: 50px;
            ">              <div class="AddTaskInputBox">
                                <input @click = "OpenDeleteEvent" style="margin-left: 0px;" type="submit" value="Delete" name="submit" />
                            </div>
                            <div class="AddTaskInputBox">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-center">
                        ...
                        <div class="delete-list-button">
                            ...
                            <div class="AddTaskInputBox no">
                                <input style="margin-left: 0px;" type="submit" value="New Blank Calendar" name="submit"
                                    id="blankCalendar" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-center2">
                    ...
                    <div class="New-list-element">
                        ...
                        <input v-model = "CalendarName" type="text" id="fname" name="fname" class="new-task-input" placeholder="Calendar Name" /><br />
                    </div>
                    <div class="New-list-element">
                        <div class="new-list-desc">
                            Colors
                        ...
                        <div class="custom-select">
                            <select class="select-items" v-model = "CalColor">
                                ...
                                <option value="green"><font-awesome-icon icon="fa-solid fa-circle" style="color: #00ff88;" />
                                    Green</option>
                                <option value="blue"><font-awesome-icon icon="fa-solid fa-circle" style="color: #0084ff;" />
                                    Blue</option>
                                <option value="purple"><font-awesome-icon icon="fa-solid fa-circle" style="color: #d400ff;" />
                                    Purple</option>
                                ...
                                <option value="red"><font-awesome-icon icon="fa-solid fa-circle" style="color: #ff0033;" />
                                    Red</option>
                                <option value="orange"><font-awesome-icon icon="fa-solid fa-circle" style="color: #ff8800;" />
                                    Orange</option>
                                <option value="yellow"><font-awesome-icon icon="fa-solid fa-circle" style="color: #ffdd00;" />
                                    Yellow</option>
                                <option value="8"><font-awesome-icon icon="fa-solid fa-circle" style="color: #ffffff;" />
                                    Custom</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-center">
                    ...
                    <div class="delete-list-button">
                        ...
                        <div class="AddTaskInputBox no">
                            <input @click = "CloseDeleteEvent" style="margin-left: 0px;" type="submit" value="Cancel" name="submit" />
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    AddEvent(){
      ...
      body: JSON.stringify({name_event : this.SelectedEventName, description:"Description", start_date : start_date, 
